...
This toolbox is written by [XU, Shuo](http://xushuo.space/wiki/doku.php?id=start) from [Beijing University of Technology](http://www.bjut.edu.cn). If you find this toolbox useful, please cite GibbsTopicModels as follows: 
